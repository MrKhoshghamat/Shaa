...
namespace Shaa.Domain.Base;

public class LazyPaging<T> : IPagedList<T>, IEnumerable<T>, IEnumerable
{
    public const int DefaultPageSize = 10;
        ...
        public LazyPaging(IEnumerable<T> source, int pageNumber, int pageSize)
        {
